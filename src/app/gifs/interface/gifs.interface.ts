// To parse this data:
//
//   import { Convert, SearchGifsResponser } from "./file";
//
//   const searchGifsResponser = Convert.toSearchGifsResponser(json);
//
...
export class Convert {
  public static toSearchGifsResponser(json: string): SearchGifsResponse {
    return cast(JSON.parse(json), r('SearchGifsResponser'));
  }

  public static searchGifsResponserToJson(value: SearchGifsResponse): string {
    return JSON.stringify(uncast(value, r('SearchGifsResponser')), null, 2);
  }
}
